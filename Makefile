...
objects=log.o math.o other.o params_dict.o path.o pointer.o string.o time.o
traceable_objects=log.o math.trace.o other.o params_dict.o path.o pointer.o string.o time.o
...
test_rand_perm.trace.out: test_rand_perm.c $(output_h) $(traceable_output_so) $(common_prerequisites)
	gcc $(common) $(CFLAGS) test_rand_perm.c -o test_rand_perm.trace.out -L$(current_dir) -lcmpltrtok_trace
...
math.trace.o: math.c $(output_h) $(common_prerequisites)
	gcc $(CFLAGS) -D TRACE -fpic -c math.c -o math.trace.o
